...
load_client_libs() {
  ...
  local lib
  for lib in color common config storage manifest download env launcher padmap pads pads-dolphin pads-ryujinx pads-cemu keys firmware remote saves qa-analyze cmd-qa cmd-uninstall; do
