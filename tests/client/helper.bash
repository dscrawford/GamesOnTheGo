...
load_client_libs() {
  ...
  local lib
  for lib in color common config manifest download env launcher pads pads-dolphin pads-ryujinx pads-cemu keys firmware remote saves qa-analyze cmd-qa; do
