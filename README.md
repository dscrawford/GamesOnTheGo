...
Native ports, not emulated: Ocarina of Time and Master Quest (Ship of Harkinian), Majora's Mask (2 Ship 2 Harkinian), Donkey Kong 64 (recomp), Snowboard Kids 2 (recomp), Super Mario 64 `pc` (sm64coopdx), Paper Mario `recut` (Wine).
